...
class MText extends Text {
  ...
  TextStyle textThemePoppins(Color? color, FontWeight? fontWeight, double? fontSize) {
  ...
  TextStyle textThemeMarkScript(Color? color, FontWeight? fontWeight, double? fontSize) {
